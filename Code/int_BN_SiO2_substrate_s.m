function iout=int_BN_SiO2_substrate_s(wl,d_grap,d_bn,d_sio2,angle)
%Returns the reflected intensity from the substrate of Graphene-BN-SiO2
%heterostructure for p polarisation. The variables with the prefix d_ are 
...
n0=1;
n1=1;% This is just about the only difference with the one with graphene
n2=2.2;
n3=1.47;
n4=Re_si-1i.*Im_si;
