function iout=int_BN_MoS2_SiO2_substrate_s(wl,d_grap,d_bn,d_mos2,d_sio2,angle)
...
Im_gra=getkgra(wl);
[nmos2,kmos2]=getnkmos2_para_pol(wl);
...
r5=(n4.*cos(angle4)-n5.*cos(angle5))./(n4.*cos(angle4)+n5.*cos(angle5));
